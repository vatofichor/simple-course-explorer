            ...
            <form method="POST">
                    ...
                    <select id="section" name="section" required>
                        ...
                        <?php foreach ($sections as $section): ?>
                            <option value="<?php echo htmlspecialchars($section); ?>">
                                <?php echo htmlspecialchars(preg_replace('/^\d+[-_]/', '', $section)) . " (" . htmlspecialchars($section) . ")"; ?>
                            </option>
                        <?php endforeach; ?>
                    </select>
                </div>
                <div class="form-row-2">
                    <div class="form-group">
                        ...
                        <input type="text" id="order_prefix" name="order_prefix" placeholder="01" required pattern="\d+">
                    </div>
                    <div class="form-group">
                        <label for="filename">Filename (e.g. Intro)</label>
                        <input type="text" id="filename" name="filename" placeholder="Intro" required pattern="[a-zA-Z0-9_\-]+">
                    </div>
                </div>
                <div class="form-group">
                    <label for="title">Page Title (Heading 1)</label>
                    <input type="text" id="title" name="title" placeholder="Introduction to Nouns" required>
                </div>
                <div class="form-group">
                    <label for="contributors">Reviewed Contributors (Optional - comma separated)</label>
                    <input type="text" id="contributors" name="contributors" placeholder="John Doe, Sarah Jenkins">
                </div>
                <div class="form-group">
                    <label for="markdown_body">Markdown Body</label>
                    <textarea id="markdown_body" name="markdown_body" placeholder="Write lesson content here in Markdown format..."></textarea>
                </div>
                <div class="btn-row">
